...
router.patch("/changePassword", authMiddleware.isLoggedin , userController.changeCurrentPassword)
router.get("/getCurrentUser", authMiddleware.isLoggedin , userController.getCurrentUser)
